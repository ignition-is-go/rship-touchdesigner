...
RShipCHOP::RShipCHOP(const OP_NodeInfo* info) : myNodeInfo(info)
{
	myExecuteCount = 0;
}
...
void
RShipCHOP::getGeneralInfo(CHOP_GeneralInfo* ginfo, const OP_Inputs* inputs, void* reserved1)
{
...
bool
RShipCHOP::getOutputInfo(CHOP_OutputInfo* info, const OP_Inputs* inputs, void* reserved1)
{
	...
	void* reserved)
{
	...
	if (ws) {
		...
		if (state == WebSocket::readyStateValues::OPEN) {
			//printf("Socket Open!\n");xx/

		}
		if (state == WebSocket::readyStateValues::CONNECTING) {
			printf("Socket Connecting!\n");

		}

		if (state == WebSocket::readyStateValues::CLOSING) {
			printf("Socket Closing!\n");

		}

		if (state == WebSocket::readyStateValues::CLOSED) {
